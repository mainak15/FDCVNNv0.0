...
def train_model(model, train_loader, val_loader, test_loader, criterion, optimizer, num_epochs=20):
    ...
    for epoch in range(num_epochs):
        ...
        if avg_val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), './Saved_Model/HAR_log_1506RB4.pth')
    ...
    model.load_state_dict(torch.load('./Saved_Model/HAR_log_1506RB4.pth'))
...
train_losses, val_losses, train_accuracies, val_accuracies = train_model(model, trainloader_fft, validationloader_fft, testloader_fft, criterion, optimizer, num_epochs=300)
